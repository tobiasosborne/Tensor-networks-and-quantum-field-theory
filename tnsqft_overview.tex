...
\end{equation}	
Using the nonhermitian operator $\widehat{k}_n$ we then obtain a local parent hamiltonian via
\begin{equation}
...
A simple argument \cite{verstraete:2005a}, somewhat analogous to the Kohn-Sham theorem \cite{hohenberg:1964a,kohn:1965a}, exposes an intriguing structure in the correlations of ground states of local hamiltonians.
